...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DixaMessenger",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// This method sets the <code>modalPresentationStyle</code> of the <code>UIHostingController</code> to <code>style</code> parameter.
...
+ (void)clearUserCredentialsWithCompletionHandler:(void (^ _Nonnull)(void))completionHandler;
